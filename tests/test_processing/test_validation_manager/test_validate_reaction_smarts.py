...
def test_validate_cheatoglobosin_1(_reaction_validator):
    ...
    prods = [
        "CC1=C[C@@H](C)CC=C[C@H]2[C@H]3O[C@]3(C)[C@@H](C)C3[C@H](Cc4c[nH]c5ccccc45)NC(=O)[C@]32C(=O)C=C[C@H](O)[C@@H]1O",
    ]
    result = _reaction_validator.validate_reaction(
        r_smarts,
        substr,
    ...
    prods = [
        "CC1=C[C@@H](C)CC=C[C@H]2[C@H]3O[C@]3(C)[C@@H](C)C3[C@H](Cc4c[nH]c5ccccc45)NC(=O)[C@]32C(=O)C=CC(=O)[C@@H]1O",
    ]
    result = _reaction_validator.validate_reaction(
        r_smarts,
        substr,
...
def test_validate_aromatic_n(_reaction_validator):
    ...
    prods = [
        "C[C@H](N)C(=O)N[C@H]1C(=O)N[C@H](C(=O)O)Cc2cn(c3ccccc23)C1c1c[nH]c2ccccc12",
    ]
    result = _reaction_validator.validate_reaction(
        r_smarts,
        substr,
